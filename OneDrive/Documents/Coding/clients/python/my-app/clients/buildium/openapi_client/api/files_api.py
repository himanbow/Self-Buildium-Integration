...
class FilesApi:
    ...
    def create_file_category(
        ...
        _param = self._create_file_category_serialize(
    ...
    @validate_call
    def create_file_category_with_http_info(
        self,
        file_category_post_message: FileCategoryPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_file_category_without_preload_content(
        self,
        file_category_post_message: FileCategoryPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _create_file_category_serialize(
        self,
    ...
    @validate_call
    def create_upload_file_request_async(
        self,
        ...
        _param = self._create_upload_file_request_async_serialize(
    ...
    @validate_call
    def create_upload_file_request_async_with_http_info(
        self,
        file_upload_post_message: FileUploadPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_upload_file_request_async_without_preload_content(
        self,
        file_upload_post_message: FileUploadPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _create_upload_file_request_async_serialize(
        self,
    ...
    def get_file_categories(
        ...
        _param = self._get_file_categories_serialize(
            orderby=orderby,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_file_categories_with_http_info(
        self,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
    ...
    @validate_call
    def get_file_categories_without_preload_content(
        self,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
    ...
    def _get_file_categories_serialize(
        self,
        orderby,
        offset,
        limit,
    ...
    def get_file_category_by_id(
        ...
        _param = self._get_file_category_by_id_serialize(
    ...
    @validate_call
    def get_file_category_by_id_with_http_info(
        self,
        file_category_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_file_category_by_id_without_preload_content(
        self,
        file_category_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_file_category_by_id_serialize(
        self,
        file_category_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_file_download_url_async(
        self,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_file_download_url_async_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_file_download_url_async_with_http_info(
        self,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_file_download_url_async_without_preload_content(
        self,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_file_download_url_async_serialize(
        self,
        file_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_file_share_settings_by_id(
        self,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_file_share_settings_by_id_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_file_share_settings_by_id_with_http_info(
        self,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_file_share_settings_by_id_without_preload_content(
        self,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_file_share_settings_by_id_serialize(
        self,
        file_id,
        _request_auth,
        _content_type,
    ...
    def update_file_category(
        ...
        _param = self._update_file_category_serialize(
            file_category_id=file_category_id,
    ...
    @validate_call
    def update_file_category_with_http_info(
        self,
        file_category_id: StrictInt,
        file_category_put_message: FileCategoryPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def update_file_category_without_preload_content(
        self,
        file_category_id: StrictInt,
        file_category_put_message: FileCategoryPutMessage,
        _request_timeout: Union[
    ...
    def _update_file_category_serialize(
        self,
        file_category_id,
    ...
    @validate_call
    def update_file_sharing_setting(
        self,
        file_id: StrictInt,
        ...
        _param = self._update_file_sharing_setting_serialize(
            file_id=file_id,
    ...
    @validate_call
    def update_file_sharing_setting_with_http_info(
        self,
        file_id: StrictInt,
        file_sharing_put_message: FileSharingPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def update_file_sharing_setting_without_preload_content(
        self,
        file_id: StrictInt,
        file_sharing_put_message: FileSharingPutMessage,
        _request_timeout: Union[
    ...
    def _update_file_sharing_setting_serialize(
        self,
        file_id,
