...
class LeaseSecurityDepositPostMessage(BaseModel):
    """
    ...
    """ # noqa: E501
    due_date: date = Field(description="The date the security deposit is due. This date will be used as the transaction date when applying the charge to the lease ledger.", alias="DueDate")
    amount: Union[StrictFloat, StrictInt] = Field(description="Security deposit amount.", alias="Amount")
