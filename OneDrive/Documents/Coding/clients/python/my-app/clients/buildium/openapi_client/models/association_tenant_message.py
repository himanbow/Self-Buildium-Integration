...
class AssociationTenantMessage(BaseModel):
    """
    ...
    move_in_date: Optional[date] = Field(default=None, description="Move in date for the tenant.", alias="MoveInDate")
    move_out_date: Optional[date] = Field(default=None, description="Move out date for the tenant.", alias="MoveOutDate")
    created_date_time: Optional[datetime] = Field(default=None, description="Date and time the tenant was created.", alias="CreatedDateTime")
    __properties: ClassVar[List[str]] = ["Id", "FirstName", "LastName", "Email", "AlternateEmail", "PhoneNumbers", "PrimaryAddress", "AlternateAddress", "Comment", "EmergencyContact", "OwnershipAccounts", "MoveInDate", "MoveOutDate", "CreatedDateTime"]
