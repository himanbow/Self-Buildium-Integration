...
class BankReconciliationUnclearTransactionsPostMessage(BaseModel):
    """
    BankReconciliationUnclearTransactionsPostMessage
    """ # noqa: E501
    transaction_ids: List[StrictInt] = Field(description="The transaction identifiers to un-clear for the reconciliation", alias="TransactionIds")
