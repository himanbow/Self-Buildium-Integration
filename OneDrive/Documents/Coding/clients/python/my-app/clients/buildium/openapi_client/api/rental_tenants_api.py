...
class RentalTenantsApi:
    ...
    def create_rental_tenant(
        ...
        _param = self._create_rental_tenant_serialize(
    ...
    @validate_call
    def create_rental_tenant_with_http_info(
        self,
        rental_tenant_post_message: RentalTenantPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_rental_tenant_without_preload_content(
        self,
        rental_tenant_post_message: RentalTenantPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _create_rental_tenant_serialize(
        self,
    ...
    def create_tenant_note(
        ...
        _param = self._create_tenant_note_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def create_tenant_note_with_http_info(
        self,
        tenant_id: StrictInt,
        note_post_message: NotePostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def create_tenant_note_without_preload_content(
        self,
        tenant_id: StrictInt,
        note_post_message: NotePostMessage,
        _request_timeout: Union[
    ...
    def _create_tenant_note_serialize(
        self,
        tenant_id,
        note_post_message,
        _request_auth,
    ...
    def get_all_tenant_notes(
        ...
        _param = self._get_all_tenant_notes_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def get_all_tenant_notes_with_http_info(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        updateddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are greater than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
        updateddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are less than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
    ...
    @validate_call
    def get_all_tenant_notes_without_preload_content(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        updateddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are greater than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
        updateddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are less than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
    ...
    def _get_all_tenant_notes_serialize(
        self,
        tenant_id,
        updateddatetimefrom,
        updateddatetimeto,
    ...
    def get_tenant_note_by_id(
        ...
        _param = self._get_tenant_note_by_id_serialize(
            tenant_id=tenant_id,
            note_id=note_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_tenant_note_by_id_with_http_info(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def get_tenant_note_by_id_without_preload_content(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
    ...
    def _get_tenant_note_by_id_serialize(
        self,
        tenant_id,
        note_id,
        _request_auth,
    ...
    def update_lease_tenant_note(
        ...
        _param = self._update_lease_tenant_note_serialize(
            tenant_id=tenant_id,
            note_id=note_id,
    ...
    @validate_call
    def update_lease_tenant_note_with_http_info(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        note_put_message: NotePutMessage,
    ...
    @validate_call
    def update_lease_tenant_note_without_preload_content(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        note_put_message: NotePutMessage,
    ...
    def _update_lease_tenant_note_serialize(
        self,
        tenant_id,
        note_id,
        note_put_message,
    ...
    def update_rental_tenant(
        ...
        _param = self._update_rental_tenant_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def update_rental_tenant_with_http_info(
        self,
        tenant_id: StrictInt,
        rental_tenant_put_message: RentalTenantPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def update_rental_tenant_without_preload_content(
        self,
        tenant_id: StrictInt,
        rental_tenant_put_message: RentalTenantPutMessage,
        _request_timeout: Union[
    ...
    def _update_rental_tenant_serialize(
        self,
        tenant_id,
