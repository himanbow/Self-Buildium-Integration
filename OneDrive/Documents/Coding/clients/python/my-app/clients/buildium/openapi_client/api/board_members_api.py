...
class BoardMembersApi:
    ...
    def create_board_member(
        ...
        _param = self._create_board_member_serialize(
    ...
    @validate_call
    def create_board_member_with_http_info(
        self,
        association_id: StrictInt,
        association_board_member_post_message: AssociationBoardMemberPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def create_board_member_without_preload_content(
        self,
        association_id: StrictInt,
        association_board_member_post_message: AssociationBoardMemberPostMessage,
        _request_timeout: Union[
    ...
    def _create_board_member_serialize(
        self,
        association_id,
    ...
    def delete_board_member(
        ...
        _param = self._delete_board_member_serialize(
            association_id=association_id,
    ...
    @validate_call
    def delete_board_member_with_http_info(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_board_member_without_preload_content(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        _request_timeout: Union[
    ...
    def _delete_board_member_serialize(
        self,
        association_id,
        board_member_id,
        _request_auth,
    ...
    @validate_call
    def get_all_association_board_members(
        self,
        association_id: StrictInt,
        ...
        _param = self._get_all_association_board_members_serialize(
            association_id=association_id,
            statuses=statuses,
    ...
    @validate_call
    def get_all_association_board_members_with_http_info(
        self,
        association_id: StrictInt,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to only records whose status is equal to the specified values.")] = None,
        boardpositiontypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to only records whose board position type is equal to the specified values.")] = None,
    ...
    @validate_call
    def get_all_association_board_members_without_preload_content(
        self,
        association_id: StrictInt,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to only records whose status is equal to the specified values.")] = None,
        boardpositiontypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to only records whose board position type is equal to the specified values.")] = None,
    ...
    def _get_all_association_board_members_serialize(
        self,
        association_id,
        statuses,
        boardpositiontypes,
    ...
    @validate_call
    def get_association_board_member_by_id(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._get_association_board_member_by_id_serialize(
            association_id=association_id,
            board_member_id=board_member_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_association_board_member_by_id_with_http_info(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def get_association_board_member_by_id_without_preload_content(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        _request_timeout: Union[
    ...
    def _get_association_board_member_by_id_serialize(
        self,
        association_id,
        board_member_id,
        _request_auth,
    ...
    @validate_call
    def update_board_member_with_http_info(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        association_board_member_put_message: AssociationBoardMemberPutMessage,
    ...
    @validate_call
    def update_board_member_without_preload_content(
        self,
        association_id: StrictInt,
        board_member_id: StrictInt,
        association_board_member_put_message: AssociationBoardMemberPutMessage,
