...
class RentalUnitFeaturesPutMessage(BaseModel):
    """
    RentalUnitFeaturesPutMessage
    """ # noqa: E501
    features: Optional[List[StrictStr]] = Field(default=None, description="A list of unit amenities. Any existing amenities associated with the unit that are not submitted in the request will be removed from the unit.", alias="Features")
