...
class BankAccountMessage(BaseModel):
    """
    This is an object that represents a bank account.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Bank account unique identifier.", alias="Id")
    gl_account: Optional[GLAccountMessage] = Field(default=None, description="General ledger account.", alias="GLAccount")
    check_printing_info: Optional[CheckPrintingInfoMessage] = Field(default=None, description="Check printing info.", alias="CheckPrintingInfo")
    electronic_payments: Optional[ElectronicPaymentsMessage] = Field(default=None, description="Electronic Payments.", alias="ElectronicPayments")
    name: Optional[StrictStr] = Field(default=None, description="Bank Account name.", alias="Name")
    description: Optional[StrictStr] = Field(default=None, description="Bank account description.", alias="Description")
    bank_account_type: Optional[StrictStr] = Field(default=None, description="Type of bank account. Values are `Checking` or `Savings`.", alias="BankAccountType")
    country: Optional[StrictStr] = Field(default=None, description="The country the bank account is in.", alias="Country")
    account_number: Optional[StrictStr] = Field(default=None, description="Bank account number.", alias="AccountNumber")
    routing_number: Optional[StrictStr] = Field(default=None, description="Bank routing number.", alias="RoutingNumber")
    is_active: Optional[StrictBool] = Field(default=None, description="Bank Account Status", alias="IsActive")
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bank Account balance", alias="Balance")
    account_number_unmasked: Optional[StrictStr] = Field(default=None, description="Unmasked bank account number", alias="AccountNumberUnmasked")
    __properties: ClassVar[List[str]] = ["Id", "GLAccount", "CheckPrintingInfo", "ElectronicPayments", "Name", "Description", "BankAccountType", "Country", "AccountNumber", "RoutingNumber", "IsActive", "Balance", "AccountNumberUnmasked"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of check_printing_info
        if self.check_printing_info:
            _dict['CheckPrintingInfo'] = self.check_printing_info.to_dict()
        # override the default output from pydantic by calling `to_dict()` of electronic_payments
        if self.electronic_payments:
            _dict['ElectronicPayments'] = self.electronic_payments.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "GLAccount": GLAccountMessage.from_dict(obj["GLAccount"]) if obj.get("GLAccount") is not None else None,
            "CheckPrintingInfo": CheckPrintingInfoMessage.from_dict(obj["CheckPrintingInfo"]) if obj.get("CheckPrintingInfo") is not None else None,
            "ElectronicPayments": ElectronicPaymentsMessage.from_dict(obj["ElectronicPayments"]) if obj.get("ElectronicPayments") is not None else None,
            "Name": obj.get("Name"),
            ...
            "AccountNumberUnmasked": obj.get("AccountNumberUnmasked")
        })
        return _obj
