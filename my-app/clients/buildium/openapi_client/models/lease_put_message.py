...
class LeasePutMessage(BaseModel):
    """
    LeasePutMessage
    """ # noqa: E501
    ...
    is_eviction_pending: StrictBool = Field(description="Indicates whether the lease has an eviction pending.", alias="IsEvictionPending")
    ...
    __properties: ClassVar[List[str]] = ["LeaseType", "UnitId", "LeaseFromDate", "LeaseToDate", "IsEvictionPending", "AutomaticallyMoveOutTenants"]
