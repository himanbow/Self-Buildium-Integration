...
class BankReconciliationClearTransactionsPostMessage(BaseModel):
    """
    BankReconciliationClearTransactionsPostMessage
    """ # noqa: E501
    transaction_ids: List[StrictInt] = Field(description="The transaction identifiers to clear for the reconciliation", alias="TransactionIds")
