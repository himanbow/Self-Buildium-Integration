...
class AssociationUnitsApi:
    ...
    def create_association_unit(
        ...
        _param = self._create_association_unit_serialize(
    ...
    @validate_call
    def create_association_unit_with_http_info(
        self,
        association_units_post_message: AssociationUnitsPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_association_unit_without_preload_content(
        self,
        association_units_post_message: AssociationUnitsPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _create_association_unit_serialize(
        self,
    ...
    @validate_call
    def create_association_unit_note(
        self,
        unit_id: StrictInt,
        ...
        _param = self._create_association_unit_note_serialize(
            unit_id=unit_id,
    ...
    @validate_call
    def create_association_unit_note_with_http_info(
        self,
        unit_id: StrictInt,
        note_post_message: NotePostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def create_association_unit_note_without_preload_content(
        self,
        unit_id: StrictInt,
        note_post_message: NotePostMessage,
        _request_timeout: Union[
    ...
    def _create_association_unit_note_serialize(
        self,
        unit_id,
        note_post_message,
        _request_auth,
    ...
    def get_all_association_units(
        ...
        _param = self._get_all_association_units_serialize(
    ...
    @validate_call
    def get_all_association_units_with_http_info(
        self,
        associationids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include Associations with matching IDs")] = None,
        lastupdatedfrom: Annotated[Optional[datetime], Field(description="Filters results to any association units that were updated on or after the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.")] = None,
        lastupdatedto: Annotated[Optional[datetime], Field(description="Filters results to any association units that were updated on or before the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.")] = None,
    ...
    @validate_call
    def get_all_association_units_without_preload_content(
        self,
        associationids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include Associations with matching IDs")] = None,
        lastupdatedfrom: Annotated[Optional[datetime], Field(description="Filters results to any association units that were updated on or after the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.")] = None,
        lastupdatedto: Annotated[Optional[datetime], Field(description="Filters results to any association units that were updated on or before the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.")] = None,
    ...
    def _get_all_association_units_serialize(
        self,
        associationids,
        lastupdatedfrom,
        lastupdatedto,
    ...
    @validate_call
    def get_association_unit_by_id(
        self,
        ...
        _param = self._get_association_unit_by_id_serialize(
            unit_id=unit_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_association_unit_by_id_with_http_info(
        self,
        unit_id: Annotated[StrictInt, Field(description="The association unit identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_association_unit_by_id_without_preload_content(
        self,
        unit_id: Annotated[StrictInt, Field(description="The association unit identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _get_association_unit_by_id_serialize(
        self,
        unit_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_association_unit_note_by_note_id(
        self,
        unit_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._get_association_unit_note_by_note_id_serialize(
            unit_id=unit_id,
            note_id=note_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_association_unit_note_by_note_id_with_http_info(
        self,
        unit_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def get_association_unit_note_by_note_id_without_preload_content(
        self,
        unit_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
    ...
    def _get_association_unit_note_by_note_id_serialize(
        self,
        unit_id,
        note_id,
        _request_auth,
    ...
    @validate_call
    def get_association_unit_notes(
        self,
        unit_id: StrictInt,
        ...
        _param = self._get_association_unit_notes_serialize(
            unit_id=unit_id,
    ...
    @validate_call
    def get_association_unit_notes_with_http_info(
        self,
        unit_id: StrictInt,
        updateddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are greater than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
        updateddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are less than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
    ...
    @validate_call
    def get_association_unit_notes_without_preload_content(
        self,
        unit_id: StrictInt,
        updateddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are greater than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
        updateddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are less than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
    ...
    def _get_association_unit_notes_serialize(
        self,
        unit_id,
        updateddatetimefrom,
        updateddatetimeto,
    ...
    def update_association_unit(
        ...
        _param = self._update_association_unit_serialize(
            unit_id=unit_id,
    ...
    @validate_call
    def update_association_unit_with_http_info(
        self,
        unit_id: Annotated[StrictInt, Field(description="The identifier of the unit to update.")],
        association_unit_put_message: AssociationUnitPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    def update_association_unit_without_preload_content(
        self,
        unit_id: Annotated[StrictInt, Field(description="The identifier of the unit to update.")],
        association_unit_put_message: AssociationUnitPutMessage,
        _request_timeout: Union[
    ...
    def _update_association_unit_serialize(
        self,
        unit_id,
    ...
    @validate_call
    def update_association_unit_note(
        self,
        unit_id: StrictInt,
        note_id: StrictInt,
        ...
        _param = self._update_association_unit_note_serialize(
            unit_id=unit_id,
            note_id=note_id,
    ...
    @validate_call
    def update_association_unit_note_with_http_info(
        self,
        unit_id: StrictInt,
        note_id: StrictInt,
        note_put_message: NotePutMessage,
    ...
    @validate_call
    def update_association_unit_note_without_preload_content(
        self,
        unit_id: StrictInt,
        note_id: StrictInt,
        note_put_message: NotePutMessage,
    ...
    def _update_association_unit_note_serialize(
        self,
        unit_id,
        note_id,
        note_put_message,
