...
class ImageReorderRequestPutMessage(BaseModel):
    """
    ImageReorderRequestPutMessage
    """ # noqa: E501
    ids: List[StrictInt] = Field(description="Unique identifiers for the images. The request must contain the ids of all images.", alias="Ids")
