...
class BankAccountPutMessage(BaseModel):
    """
    BankAccountPutMessage
    """ # noqa: E501
    check_printing_info: CheckPrintingInfoPutMessage = Field(description="Check printing info.", alias="CheckPrintingInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CheckPrintingInfo": CheckPrintingInfoPutMessage.from_dict(obj["CheckPrintingInfo"]) if obj.get("CheckPrintingInfo") is not None else None,
            "Name": obj.get("Name"),
