...
class AddressMessage(BaseModel):
    ...
    Address.
    """ # noqa: E501
    address_line1: Optional[StrictStr] = Field(default=None, description="Address line 1 (e.g., street, PO Box, or company name).", alias="AddressLine1")
    address_line2: Optional[StrictStr] = Field(default=None, description="Address line 2 (e.g., apartment, suite, unit, or building).", alias="AddressLine2")
    address_line3: Optional[StrictStr] = Field(default=None, description="Address line 3", alias="AddressLine3")
    city: Optional[StrictStr] = Field(default=None, description="City, district, suburb, town, or village.", alias="City")
    state: Optional[StrictStr] = Field(default=None, description="State, county, province, or region.", alias="State")
    postal_code: Optional[StrictStr] = Field(default=None, description="ZIP or postal code.", alias="PostalCode")
    country: Optional[StrictStr] = Field(default=None, description="Country.", alias="Country")
