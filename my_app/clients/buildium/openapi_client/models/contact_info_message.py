...
class ContactInfoMessage(BaseModel):
    """
    Contact information.
    """ # noqa: E501
    ...
    address: Optional[AddressMessage] = Field(default=None, description="Contact address.", alias="Address")
    phone_number: Optional[StrictStr] = Field(default=None, description="Contact phone number.", alias="PhoneNumber")
    __properties: ClassVar[List[str]] = ["FirstName", "LastName", "Address", "PhoneNumber"]
